...
class MyRecordHelper:
    ...
    def get_my_record_f5(cself):
        try:
            with CPyString.fromPyOpt(CPyRecord.toPy(None, cself).test31) as py_obj:
    ...
    def get_my_record_f7(cself):
        try:
            with CPyBoxedDate.fromPyOpt(CPyRecord.toPy(None, cself).test41) as py_obj:
                return py_obj.release_djinni_boxed()
        except Exception as _djinni_py_e:
            CPyException.setExceptionFromPy(_djinni_py_e)
            return ffi.NULL
    ...
    def get_my_record_f14(cself):
        try:
            _ret = CPyObject.fromPy(ListRecordRcHelper.c_data_set, CPyRecord.toPy(None, cself).test101)
            assert _ret != ffi.NULL
            return _ret
        except Exception as _djinni_py_e:
            CPyException.setExceptionFromPy(_djinni_py_e)
    ...
    def python_create_my_record(test,test1,test2,test3,test31,test4,test41,test5,test6,test7,test8,test9,test10,test101,test11,test12,test13,test14,test15,test16,test17):
        py_rec = MyRecord(
            CPyPrimitive.toPy(test),
            CPyBoxedI32.toPyOpt(test1),
            CPyObject.toPy(ListInt32THelper.c_data_set, test2),
            CPyString.toPy(test3),
            CPyString.toPyOpt(test31),
            CPyDate.toPy(test4),
            CPyBoxedDate.toPyOpt(test41),
