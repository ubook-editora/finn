...
class MyRecordHelper:
    ...
    def python_create_my_record(test,test1,test2,test3,test31,test4,test41,test5,test6,test7,test8,test9,test10,test101,test11,test13,test14,test15,test16,test17):
        py_rec = MyRecord(
