...
void my_record_add_callback_get_my_record_f16(int( * ptr)(struct DjinniRecordHandle *));
void my_record_add_callback_get_my_record_f17(struct DjinniBoxedI16 *( * ptr)(struct DjinniRecordHandle *));
