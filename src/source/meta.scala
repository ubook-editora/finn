...
package object meta {
  ...
  abstract sealed class MOpaque extends Meta {
    val idlName: String
  }
  ...
  case class MParam(name: String) extends Meta {
    val numParams = 0
  }
  ...
  case class MPrimitive(_idlName: String, jName: String, jniName: String, cName: String, jBoxed: String, jSig: String, objcName: String, objcBoxed: String) extends MOpaque {
    val numParams = 0;
  ...
  case object MDate extends MOpaque {
    val numParams = 0;
    val idlName = "date"
  }
  ...
  case object MOptional extends MOpaque {
    val numParams = 1;
    val idlName = "optional"
  }

  case object MList extends MOpaque {
    val numParams = 1;
    val idlName = "list"
  }

  case object MSet extends MOpaque {
    val numParams = 1;
    val idlName = "set"
  }

  case object MMap extends MOpaque {
    val numParams = 2;
    val idlName = "map"
  }

  case object MJson extends MOpaque {
    val numParams = 0;
    val idlName = "json"
  }
}
